#!/usr/bin/env python3
"""
Complete Training Script for Transformer on WikiText-103
...
import time
import sys
from transformer_lightning import Transformer
...
def main():
    ...
    parser.add_argument('--nhid', type=int, default=256, 
                       help='Dimension of embedding and attention mechanism')
    parser.add_argument('--nheads', type=int, default=4, 
                       help='Number of attention heads')
    parser.add_argument('--d_ff', type=int, default = 256, help='Dimension of the feedforward layer')
