...
xp_parser.add_argument('--grid_search_script', type=str, default='colorlessgreenRNNs/wm_xp/gs_eval.sh')
#eval argument
xp_parser.add_argument('--nounpp', type=str, default = "colorlessgreenRNNs/NounPP/Stimuli/nounpp.txt")
xp_parser.add_argument('--eval_script', type=str, default='colorlessgreenRNNs/wm_xp/tests/tests.py',
