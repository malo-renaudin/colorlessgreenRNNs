...
python /scratch2/mrenaudin/colorlessgreenRNNs/wm_xp/runner.py \
    ...
    --grid_search_script /scratch2/mrenaudin/colorlessgreenRNNs/wm_xp/gs_eval.sh \
    --eval_script /scratch2/mrenaudin/colorlessgreenRNNs/wm_xp/tests/tests.py \
