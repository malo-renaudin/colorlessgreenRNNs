        ...
        for token in tokens:
            if token in self.word2idx:
                ...
                if 0 <= token_id < len(self.word2idx):
                    ...
                    print(f"Warning: Invalid token ID {token_id} for token '{token}', using UNK")
            ...
            if text.strip():  # Skip empty texts
                ...
                for token_id in tokens:
                    if 0 <= token_id < vocab_size:
                        ...
                        print(f"Warning: Token ID {token_id} out of bounds (vocab_size={vocab_size}), replacing with UNK")
