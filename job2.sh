#!/bin/bash
#SBATCH --job-name=cbr_rnn_good # Job name
...
python src/language_models/main.py --data /scratch2/mrenaudin/colorlessgreenRNNs/english_data --name test_cbr_scaled --classmodel 'CBR_RNN' --lr 1.0 --cuda
