...
#single head cbr rnn
#python src/language_models/main.py --data /scratch2/mrenaudin/colorlessgreenRNNs/english_data --name cbr_1h_128_gumbel_softmax --classmodel 'CBR_RNN' --batch_size 256 --emsize 128 --nhid 128 --optimizer 'Adam' --gumbel_softmax --cuda  #--checkpoint_path /scratch2/mrenaudin/colorlessgreenRNNs/checkpoints/cbr_1h_512/epoch_15.pt --epoch_checkpointed 15
#multi head cbr rnn
