...
main_name = "/scratch2/mrenaudin/colorlessgreenRNNs/eval_surprisal/get_surprisal/data/items_ClassicGP"
other_names = ["/scratch2/mrenaudin/colorlessgreenRNNs/eval_surprisal/get_surprisal/data/items_Agreement", 
               "/scratch2/mrenaudin/colorlessgreenRNNs/eval_surprisal/get_surprisal/data/items_AttachmentAmbiguity", 
               "/scratch2/mrenaudin/colorlessgreenRNNs/eval_surprisal/get_surprisal/data/items_RelativeClause", 
               "/scratch2/mrenaudin/colorlessgreenRNNs/eval_surprisal/get_surprisal/data/items_filler", 
               "/scratch2/mrenaudin/colorlessgreenRNNs/eval_surprisal/get_surprisal/data/items_plaus"]
